...
# web application at http://ForShow.pythonanywhere.com/
...
#import sys
#
#path = '/home/ForShow/path/to/my/app
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## assuming your django settings file is at '/home/ForShow/mysite/mysite/settings.py'
## and your manage.py is is at '/home/ForShow/mysite/manage.py'
#path = '/home/ForShow/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## The "/home/ForShow" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/ForShow/myproject"
#path = '/home/ForShow/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
